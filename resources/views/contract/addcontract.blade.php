        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item"><a class="d-flex align-items-center"  href="{{route('contract.index')}}"><i data-feather="file-text"></i><span class="menu-title text-truncate" data-i18n="Invoice">Contracts</span></a>
                <ul class="menu-content">
                    ...
                    <li class="active"><a class="d-flex align-items-center" href="contract-add.html"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Add">Add</span></a>
                    </li>
                </ul>
            </li>
        </ul>
                                    ...
                                    <div class="invoice-number-date mt-md-0 mt-2">
                                        <div class="d-flex align-items-center justify-content-md-end mb-1">
                                            ...
                                            <div class="input-group input-group-merge invoice-edit-input-group">
                                                <input type="text" class="form-control invoice-edit-input" placeholder="contract name" name="contract_name" required/>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center mb-1">
                                            <span class="title">Contract Status:</span>
                                            <select class="form-select" name="contrcat_status" required>
                                    ...
                                    <div class="invoice-number-date mt-md-0 mt-2">
                                        <div class="d-flex align-items-center justify-content-md-end mb-1">
                                            ...
                                            <div class="input-group input-group-merge invoice-edit-input-group">
                                                ...
                                                <input type="text" class="form-control invoice-edit-input" placeholder="53634" name="contract_reft_number" required/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="invoice-number-date mt-md-0 mt-2">
                                        <div class="d-flex align-items-center flex-column justify-content-md-end mb-1">
                                            ...
                                            <div class="input-group input-group-merge invoice-edit-input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="arabic name" name="client_name_ar"/>
                                            </div>
                                            <div class="input-group input-group-merge invoice-edit-input-group mt-2">
                                                <div class="input-group-text">
                                                    <i data-feather="hash"></i>
                                                </div>
                                                <input type="text" class="form-control" placeholder="English name"  name="contract_client_name" required/>
                                            </div>
                                            ...
                                            <div class="input-group input-group-merge invoice-edit-input-group mt-2">
                                                ...
                                                <input type="text" class="form-control" placeholder="country name"  name="client_country" required/>
                                            </div>
                                    ...
                                    <div class="col-xl-6 mb-lg-1 col-bill-to ps-0">
                                        <div>
                                            ...
                                            <div class="input-group input-group-merge invoice-edit-input-group ">
                                                ...
                                                <input  class="form-control" type="date" placeholder="yyyy-mm-dd" name="agreement_date_en" required/>
                                            </div>
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <div class="input-group input-group-merge invoice-edit-input-group mt-2">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="client name" name="introduced_to_en" required/>
                                                    </div>, (Hereinafter referred to as "2nd Party'').
                                                    <div class="input-group input-group-merge invoice-edit-input-group mt-2">
                                                        <div class="input-group-text">
                                                            <i data-feather="hash"></i>
                                                        </div>
                                                        <input type="text" class="form-control" placeholder="address" name="client_address_en" required/>
                                                    </div>
                                                    <br><br>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <table class="table" id="service_english_table">
                                                        ...
                                                        <tbody>
                                                            @foreach (old('service_name_en', ['']) as $index => $oldProduct)
                                                            <tr id="serviceen{{ $index }}">
                                                 
                                                                <td>
                                                                <input type="text" class="form-control" placeholder="service name" name="service_name_en[]"  value="{{ old('service_name_en.' . $index) ?? '1' }}" required>
                                                                </td>

                                                                <td>
                                                                   {{-- <input type="number" name="quantities[]" class="form-control" value="1" /> --}}
                                                                <input type="text" class="form-control" placeholder="24" name="service_cost_en[]"  value="{{ old('service_cost_en.' . $index) ?? '1' }}"  required/>
                                                                </td>

                                                                <td>
                                                                <textarea class="form-control mt-2" rows="4" name="service_desc_en[]" value="{{ old('service_desc_en.' . $index) ?? '1' }}" required>this is service description</textarea>
                                                                </td>
                                                            </tr>

                                                             @endforeach

                                                            <tr  id="serviceen{{ count(old('service_name_en', [''])) }}"></tr>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <button id='delete_row_en' class="pull-right btn btn-danger">- Delete Row</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div style="direction: rtl" class="col-xl-6 mb-lg-1 col-bill-to ps-0">
                                        <div>
                                            ...
                                            <div class="input-group input-group-merge invoice-edit-input-group ">
                                                ...
                                                <input  class="form-control" type="date" placeholder="date" name="agreement_date_ar" required />
                                            </div>
                                            2022, بين:
                                            <ul>
                                                <li>
                                                ...
                                                <li>
                                                    <div class="input-group input-group-merge invoice-edit-input-group mt-2">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="client name" name="introduced_to_ar" required/>

                                                    </div>(المشار إليه فيما بعدب'' الطرف الثاني/العميل)،
                                                    <div class="input-group input-group-merge invoice-edit-input-group mt-2">

                                                        <input type="text" class="form-control" placeholder="address" name="client_address_ar" required/>
                                                    </div>
                                                    <br><br>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <table class="table" id="service_arabic_table">
                                                        ...
                                                        <tbody>
                                                            @foreach (old('service_name_ar', ['']) as $index => $oldProduct)
                                                            <tr id="servicear{{ $index }}">
                                                                <td >
                                                                    
                                                                        
                                                                <input type="text" class="form-control" placeholder="service name" name="service_name_ar[]"  value="{{ old('service_name_ar.' . $index) ?? '1' }}" required />
                                                                </td>
                                                                        
                                                                <td >
                                                                   {{-- <input type="number" name="quantities[]" class="form-control" value="1" /> --}}
                                                                   
                                                                <input type="text" class="form-control" placeholder="24" name="service_cost_ar[]"  value="{{ old('service_cost_ar.' . $index) ?? '1' }}"  required/>
                                                                </td> 
                                                               
                                                                <td >
                                                                <textarea class="form-control mt-2" rows="4" name="service_desc_ar[]" value="{{ old('service_desc_ar.' . $index) ?? '1' }}">this is service description</textarea>
                                                                </td>
                                                            ...
                                                            <tr  id="servicear{{ count(old('service_name_ar', [''])) }}"></tr>
                                        ...
                                        <div>
                                            ...
                                            <div class="input-group input-group-merge invoice-edit-input-group mt-2">
                                                ...
                                                <input type="number" class="form-control" placeholder="duration" name="duration_ar" required/>
                            ...
                            <div class="card-body invoice-padding py-0">
                                ...
                                <div class="row">
                                    <div style="direction: rtl" class="col-6">
                                        <div class="mb-2">
                                            <h2 class="fw-bold d-flex">الطرف الثاني : &nbsp;<input style="width: 65%" type="text" class="form-control" placeholder="data" name="sign_second_party" required/></h2>
                                            <h2 class="fw-bold">التوقيع : ........................................................</h2>
                                            <h2 class="fw-bold d-flex">السيد : &nbsp;<input style="width: 65%" type="text" class="form-control" placeholder="data"  name="sign_second_party_mister" required/></h2>
                                            <h2 class="fw-bold">الصفة : ........................................................</h2>
                                            <h2 class="fw-bold d-flex">التاريخ: &nbsp;<input style="width: 65%" type="date" class="form-control" placeholder="data" name="contract_date_ar" required /></h2>
                                        </div>
                                    </div>
                                    <div style="direction: rtl" class="col-6">
                                        <div class="mb-2">
                                            ...
                                            <h2 class="fw-bold d-flex">التاريخ: &nbsp;<input style="width: 65%" type="date" class="form-control" placeholder="data" name="contract_date_en" required/></h2>
                                        </div>
                                    </div>
                                </div>
                                <!-- Invoice Note ends -->
